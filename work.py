...
class ColorApp:
    ...
    def setup_ui(self):
        ...
        self.search_entry.insert(0, "Search colors, HEX, RGB...")
        self.search_entry.bind("<FocusIn>", lambda e: self.search_entry.delete(0, tk.END) if self.search_entry.get() == "Search colors, HEX, RGB..." else None)
    ...
    def fetch_and_render(self):
        ...
        if query_text == "Search colors, HEX, RGB...":
            query_text = ""
